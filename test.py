...
result = subprocess.run(["gst-launch-1.0", "multifilesrc", "location=MOT16-04/img1/%06d.jpg", "start-index=1",
                         "caps='image/jpeg',framerate=30", "!", "decodebin", "!", "videoscale", "!",
                         "video/x-raw,width=1920,height=1080", "!", "videoconvert", "!",
                         "x264enc", "pass=5", "speed-preset=1", "quantizer=20", "tune=zerolatency", "thread=8", "!",
                         "avimux", "!", "filesink", "location=test.avi"], stdout=subprocess.PIPE)
